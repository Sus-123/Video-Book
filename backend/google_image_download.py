...
def download_images(query,num_images=2):
    image_type="image"#'alam khan rana'
    query= query.split()    #['alam','khan','rana']
    querys='+'.join(query)   #'alam+khan+rana'
    ...
    # list = soup.find_all("div",{"class":"rg_meta"})
    # print len(list)
    c=0
